...
const AddPinnedTabModal = () => {
    return (
        <div className="modal fade AddPinnedTabModal" tabIndex={-1} aria-hidden="true">
            <div className="modal-dialog modal-dialog-centered">
                <div className="modal-content shadow-lg border-0">
                    <div className="modal-body p-0">
                        <div className="text-center p-4 pb-0">
                            <div className="avatar-xl mx-auto mb-4">
                                <img src="assets/images/users/avatar-7.jpg" alt="" className="img-thumbnail rounded-circle" />
                            </div>
                        ...
                        <div className="p-4 bg-soft-primary mt-n4">
                            <div className="mt-4 text-center">
                                <h5 className="font-size-18 mb-0 text-truncate">Jean Berwick</h5>
                            </div>
                        </div>
                    </div>
                </div>
