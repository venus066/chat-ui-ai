...
const UpdateDeleteBookmark = ({ isOpen, onClose, onUpdate, bookmark }: UpdateDeleteBookmarkProps) => {
    /*
    ...
    return (
        <Modal isOpen={isOpen} toggle={onClose}>
            ...
            <ModalBody>
                <Form>
                    <FormGroup>
                        <Label htmlFor="update-bookmark" className="mb-2">Bookmark Title</Label>
                        <Input
                            type="text"
                            name="email" id="update-bookmark"
