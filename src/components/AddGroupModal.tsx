        ...
        <li>
            <div className="form-check">
                ...
                <Label className="form-check-label"
                    htmlFor={`contact-${contact.id}`}>{fullName}</Label>
            </div>
        </li>
    );
};
...
const AddGroupModal = ({ isOpen, onClose, onCreateChannel }: AddGroupModalProps) => {
    /*
    collapse handeling
    */
  ...
  */
    ...
    */
    ...
    return (
        <Modal isOpen={isOpen} toggle={onClose} tabIndex={-1} centered scrollable id="addgroup-exampleModal" role="dialog">
            <ModalHeader
            ...
            <ModalFooter>
                <Button color="link" type="button" >Close</Button>
                <Button type="button" color="primary" onClick={onSubmit} disabled={!valid}>Create Groups</Button>
            </ModalFooter>
        </Modal>
    );
};
