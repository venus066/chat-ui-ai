...
// interface
import { MessagesTypes, ImageTypes, AttachmentTypes } from "../../../data/messages";
...
const Menu = () => {
    ...
    return (
        <Dropdown isOpen={dropdownOpen} toggle={toggle} className="align-self-start message-box-drop">
            <DropdownToggle
    ...
    return (
        <div className="message-img-link">
            <ul className="list-inline mb-0">
                <UncontrolledDropdown tag="li" color="none" className="list-inline-item dropdown">
                    <DropdownToggle
                        tag="a"
                        role="button"
                        className="btn btn-toggle"
        ...
        <>
            {
                (attachments || []).map((attachment: AttachmentTypes, key: number) =>
                    <div key={key} className={classnames("p-3", "border-primary", "border rounded-3", { "pt-2": key !== 0 })}>
            ...
            <div className="conversation-list">
                ...
                <div className="user-chat-content">
                    <div className="ctext-wrap">
                        ...
                        {/* image message start */}
                        {
                            hasImages ? <Images images={message.image!} />
                                :
                                <>
                    ...
                    <div className="conversation-name">
                        {
                            isFromMe ? <>
                                ...
                                <>
                                    {fullName}
                                    <small className={classnames("text-muted", "mb-0", "ms-2")}>{date}</small>
